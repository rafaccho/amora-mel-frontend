...
export type Endpoint = 'pedidos' | 'areas_entregas' | 'fornecedores' | 'lojas' | 'produtos' | 'produto_fornecedores' | 'compras' | 'areas_entregas_produto' | 'agrupamentos' | 'estoques' | 'login'
